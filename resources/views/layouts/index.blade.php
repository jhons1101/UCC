...
<html lang="en">
    ...
    <body>
        ...
        <div id="fb-root"></div>
        <script async defer crossorigin="anonymous" src="https://connect.facebook.net/es_LA/sdk.js#xfbml=1&version=v17.0&appId=593811532692273&autoLogAppEvents=1" nonce="MyjZrIok"></script>

        <main id="main">
            <!-- ======= Header Section ======= -->
            @yield('header')

            <!-- ======= Principal Carousel Section ======= -->
            @yield('carousel')
